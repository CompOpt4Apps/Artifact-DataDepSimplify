...
#include "../src/fs_csr_original.h"
#include "../src/fs_csr_inspector.h"
#include "../src/fs_csr_executor.h"
...
//  Running Inspector 
 ...
 //A2 = Amat;
        ...
        /*fs_csr_inspector(n,A2->p, A2->i, DAG_s);
        ...
        fs_csr_inspector(n,A2->p, A2->i, DAG);
