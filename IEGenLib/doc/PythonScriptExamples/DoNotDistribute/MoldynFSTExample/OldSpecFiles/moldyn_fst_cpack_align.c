/*! \file
 *
 * Driver for moldyn_fst_cpack_align example.  Written by hand.
 * We didn't need any changes from the moldyn_fst_cpack example.
 * Is it the naming scheme that requires having a separate file?
 *
